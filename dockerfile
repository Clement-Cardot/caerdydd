...
COPY .ci/config/tomcat/tomcat-users.xml /usr/local/tomcat/conf/tomcat-users.xml
COPY .ci/config/tomcat/context.xml /usr/local/tomcat/webapps/manager/META-INF/context.xml
