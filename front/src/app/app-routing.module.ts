...
const routes: Routes = [
  ...
  // Notation pages
  {
    ...
    component: NotationPageComponent,
    canActivate: [AuthGuard, RoleGuard],
  ...
  // Subject page
  {
    ...
    component: ValidateSubjectPageComponent,
    canActivate: [AuthGuard, RoleGuard],
    data: { roles: ['OPTION_LEADER_ROLE'] },
  },
  ...
  },
  {
    ...
    component: DevProjectPageComponent,
    canActivate: [AuthGuard, RoleGuard],
  ...
  },
  {
    ...
    component: ValidationProjectPageComponent,
    canActivate: [AuthGuard, RoleGuard],
    data: { roles: ['TEAM_MEMBER_ROLE'] },
  },
  ...
  // Teaching Staff Pages
  {
    ...
    component: TeachingStaffPageComponent,
    canActivate: [AuthGuard, RoleGuard],
